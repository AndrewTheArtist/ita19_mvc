...
# Elemendide kustutamise sõnumid
    ...
    def kustuta_elemendid(self):
        print("Kõik elemendid on läinud. Ainukt võimalus neid tagasi saada, on  palvetada jumala poole".format())
        print("See ei olnud nali. Kõik on päriselt läinud. Nägemist!".format())